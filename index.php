  ...
  <!-- <section id="mu-slider"> -->
      ...
      <div class="mu-slider-content">
        <div class="row">
          <div class="col-md-7 col-md-offset-5">
            <p style="color:black;font-size:16px;text-align:left;margin-top:10px;" class="pull-left">Architecture is an event that suddenly emerges from the mind or soul of the architect. Architect may be preoccupied with the making of the building solid, or meeting demands for comfort,when suddenly he finds himself uplifted by a desire to do more than simply meet needs -he wants to express lyrical forces that give him joy. </p>
    ...
    <!-- <div class="mu-slider-single">
      ...
      <div class="mu-slider-content">
	       <div class="row">
          <div class="col-md-7 col-md-offset-5">
            <p style="color:white;font-size:46px;text-align:left;margin-top:20px;background:rgba(0,0,0,0.75);" class="pull-left">Engala Enclave</p>
            <p class="pull-right" style="color:white;background:rgba(0,0,0,0.75);font-size:20px;">Warangal</p>
          </div>
        </div>
      </div>
    </div> -->
    ...
    <!-- <div class="mu-slider-single">
      ...
      <div class="mu-slider-content">
        <div class="row">
          <div class="col-md-7 col-md-offset-5">
            <p style="color:white;font-size:46px;text-align:left;margin-top:20px;background:rgba(0,0,0,0.75);" class="pull-left">Lahari Villas</p>
            <p class="pull-right" style="color:white;background:rgba(0,0,0,0.75);font-size:20px;">Hyderabad</p>
          </div>
        </div>
      </div>
    </div> -->
